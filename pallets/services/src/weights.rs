//! Autogenerated weights for services_benchmarking
//!
...
/// Weight functions needed for services_benchmarking.
...
/// Weights for services_benchmarking using the Substrate node and recommended hardware.
